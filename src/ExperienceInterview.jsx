            ...
            >
              {message.type === 'ai' ? (
                <div style={{ display: 'flex', gap: 16, alignItems: 'flex-start', maxWidth: 512 }}>
                  <div style={{ flexShrink: 0, width: 48, height: 48, borderRadius: '50%', background: 'linear-gradient(135deg, #00D4FF, #0099CC)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
