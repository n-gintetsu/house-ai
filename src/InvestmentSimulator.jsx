    ...
    <div style={{ background: C.bg, minHeight: '100vh', fontFamily: "'Noto Sans JP', sans-serif", paddingBottom: 60 }}>
      ...
      <div style={{ padding: '16px', maxWidth: 720, margin: '0 auto' }}>
        ...
        <div style={{ background: C.card, borderRadius: 16, padding: '16px', marginBottom: 16, border: `1px solid ${C.border}` }}>
          <p style={{ fontSize: 14, fontWeight: 700, color: C.navy, margin: '0 0 14px' }}><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#c9a84c" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{display:'inline-block',verticalAlign:'middle',marginRight:'6px',position:'relative',top:'-1px'}}><rect x="9" y="2" width="6" height="4" rx="1"/><path d="M4 7h16v14a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1z"/><line x1="9" y1="12" x2="15" y2="12"/><line x1="9" y1="16" x2="13" y2="16"/></svg>物件情報を入力</p>
        ...
        <div ref={resultRef} style={{ background: C.card, borderRadius: 16, padding: '16px', marginBottom: 16, border: `1px solid ${C.border}` }}>
          <p style={{ fontSize: 14, fontWeight: 700, color: C.navy, margin: '0 0 14px' }}><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#c9a84c" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{display:'inline-block',verticalAlign:'middle',marginRight:'6px',position:'relative',top:'-1px'}}><rect x="3" y="12" width="4" height="9"/><rect x="10" y="7" width="4" height="14"/><rect x="17" y="3" width="4" height="18"/></svg>算出指標（リアルタイム）</p>
        ...
        <button onClick={handleAI} disabled={loading}
          ...
          {loading ? (<><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{display:'inline-block',verticalAlign:'middle',marginRight:'6px',position:'relative',top:'-1px'}}><path d="M12 2a4 4 0 0 1 4 4c0 1.5-.8 2.8-2 3.5V12h-4V9.5A4 4 0 0 1 8 6a4 4 0 0 1 4-4z"/><path d="M8 12H6a2 2 0 0 0-2 2v1a2 2 0 0 0 2 2h1"/><path d="M16 12h2a2 2 0 0 1 2 2v1a2 2 0 0 1-2 2h-1"/><path d="M9 17v2a1 1 0 0 0 1 1h4a1 1 0 0 0 1-1v-2"/></svg>{'AI分析中...'}</>) : (<><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{display:'inline-block',verticalAlign:'middle',marginRight:'6px',position:'relative',top:'-1px'}}><path d="M12 2a4 4 0 0 1 4 4c0 1.5-.8 2.8-2 3.5V12h-4V9.5A4 4 0 0 1 8 6a4 4 0 0 1 4-4z"/><path d="M8 12H6a2 2 0 0 0-2 2v1a2 2 0 0 0 2 2h1"/><path d="M16 12h2a2 2 0 0 1 2 2v1a2 2 0 0 1-2 2h-1"/><path d="M9 17v2a1 1 0 0 0 1 1h4a1 1 0 0 0 1-1v-2"/></svg>{'AIの判断・アドバイスを見る'}</>)}
        </button>

        {/* AIアドバイス結果 */}
        {aiAdvice && (
          <div style={{ background: C.card, borderRadius: 16, padding: '16px', border: `1px solid ${C.border}`, marginBottom: 16 }}>
            <p style={{ fontSize: 14, fontWeight: 700, color: C.navy, margin: '0 0 10px' }}><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#c9a84c" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{display:'inline-block',verticalAlign:'middle',marginRight:'6px',position:'relative',top:'-1px'}}><path d="M12 2a4 4 0 0 1 4 4c0 1.5-.8 2.8-2 3.5V12h-4V9.5A4 4 0 0 1 8 6a4 4 0 0 1 4-4z"/><path d="M8 12H6a2 2 0 0 0-2 2v1a2 2 0 0 0 2 2h1"/><path d="M16 12h2a2 2 0 0 1 2 2v1a2 2 0 0 1-2 2h-1"/><path d="M9 17v2a1 1 0 0 0 1 1h4a1 1 0 0 0 1-1v-2"/></svg>AIアドバイス</p>
            ...
            <button onClick={() => onNavigate && onNavigate('properties')}
              ...
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{display:'inline-block',verticalAlign:'middle',marginRight:'6px',position:'relative',top:'-1px'}}><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg>実際の投資物件を見る
            </button>
